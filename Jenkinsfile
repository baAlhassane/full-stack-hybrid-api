...
//job et jenkinfile marche affiche la page de jenkins par defaut. Donc il faut confirer angular
...
//         // --- NOUVELLE ÉTAPE : Build et Push de l'Image Docker du Backend ---
...
//         // --- NOUVELLE ÉTAPE : Build et Push de l'Image Docker du Frontend ---
...
//                         echo "Attente du démarrage des pods et vérification de leur statut..."
//                         // Attendre un peu pour que les pods aient le temps de démarrer
//                         sleep 60 // Attendre 60 secondes (peut être ajusté)

//                         // Vérifier l'état des pods (cette sortie est CRUCIALE !)
